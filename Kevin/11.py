...
input = """LLLLLLLL.LLLL.LLLLLLLLL.LLLLLL..L.LLLLL.LLLLL.LLLLLL.LLLLLLLLLLLLLL.LLLLLLLLLLLLLL.L.LLLLLLLLLL
    ...
    for x in range(0, len(array)):
        for y in range(0, len(array[x])):
            ...
            for i in range(-1, 2):
                for j in range(-1, 2):
                    if x+i >= 0 and y+j >= 0:
                        if x+i < len(array) and y+j < len(array[x]):
                            if i != 0 or j != 0:
                                if seat_array[x+i][y+j] == '#':
                                    occupied_adjacent+=1
